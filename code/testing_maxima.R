...
# Description: This code calculates the confidence interval of a peak given a gam
...
# curve satisfy the test for a point potentially being an extremum 
# The first deriv criteria determines if the confidence intervals for the first 
...
#Parameters determining how large the range of x is
low_lim = 0.1
high_lim =4
